...
<AccordionGroup>
  ...
  <Accordion icon="rectangle-terminal" title="Preview the docs">
...
<AccordionGroup>
  ...
  <Accordion icon="rocket" title="Push your changes">
    ...
    for your changes to update in your docs site. If you git and the github app
    have been configured correctly, you will see the updated docs online shortly
    after.

    ## Update your docs

    Add content directly in your files with MDX syntax and React components. You
    can use any of our components, or even build your own.
